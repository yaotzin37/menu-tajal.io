...
def generar_menu_mixologia():
    """
    Genera el archivo HTML para el menú de mixologia a partir de un archivo CSV.
    """
    ...
    # Filtrar solo mixología (excluir platillos)
    if 'Nota' in df.columns:
        df = df[df['Nota'] == 'menú-mixología']
...
<head>
    ...
    <meta name="description" content="Carta de mixologia de Tajal: cortes a la parrilla, mariscos, ensaladas, pastas, hamburguesas y postres. Cocina que fusiona tradición y vanguardia.">
    <meta property="og:title" content="Carta de Mixología | Tajal - Restaurante & Mixología">
    <meta property="og:description" content="Descubre nuestra selección de mixologia: cortes, mariscos, ensaladas, pastas y más.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://tajalrestaurante.com/menu-mixologia.html">
...
<body class="menu-page menu-mixologia">
    <div class="menu-hero">
        <video class="hero-video" autoplay loop muted playsinline preload="metadata" poster="assets/images/menu/ambiente/ambiente-1.webp">
            <!-- Video para móviles (Portrait) -->
            <source src="assets/video/mobile_hero_menu.mp4" type="video/mp4" media="(max-width: 768px)">
            <!-- Video para desktop (Landscape) -->
            <source src="assets/video/hero-mixologia.mp4" type="video/mp4">
        </video>
        <div class="menu-hero-overlay"></div>
        <div class="menu-hero-content">
            <h1>Nuestra Mixología</h1>
            <p>Descubre nuestra selección de mixologia que fusionan tradición y vanguardia</p>
        </div>
    </div>
    <div class="container">
        <h1>Carta de Bebidas</h1>
        <p class="distinctive">Disfruta de nuestra selección de mixologia preparados con los mejores ingredientes y técnicas culinarias, fusionando sabores tradicionales con toques contemporáneos.</p>
"""
    ...
    categorias_unicas = [c for c in df['CATEGORIA'].dropna().unique()]
    if categorias_unicas:
        html_content += """
        <div class="search-container">
            <input type="text" id="search-input" class="search-input" placeholder="Buscar bebida...">
        </div>
        """
    ...
    <div class="floating-nav">
        ...
        <a href="menu-platillos.html" class="floating-btn" title="Carta de Alimentos">
            <i class="fas fa-utensils"></i>
        </a>
        <a href="menu-mixologia.html" class="floating-btn active" title="Carta de Mixología">
...
"""
    ...
    # Guardar el nuevo archivo HTML
    output_path = os.path.join(base_dir, 'menu-mixologia.html')
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("Se ha generado el archivo 'menu-mixologia.html'")

if __name__ == "__main__":
    generar_menu_mixologia()
